...
public class Playground {
    ...
    public Playground (String pathName){
        try{
            ...
            final Image pathWest = ImageIO.read(new File("./img/grassPathWest.png"));
                ...
                for (byte element : line.getBytes(StandardCharsets.UTF_8)){
                    switch (element){
                        case 'T' : environment.add(new SolidSprite(columnNumber*imageTreeWidth,
                                lineNumber*imageTreeHeight,imageTree, imageTreeWidth, imageTreeHeight, null, null));
                            break;
                        case ' ' : environment.add(new Sprite(columnNumber*imageGrassWidth,
                                lineNumber*imageGrassHeight, imageGrass, imageGrassWidth, imageGrassHeight, null, null));
                            break;
                        case 'R' : environment.add(new SolidSprite(columnNumber*imageRockWidth,
                                lineNumber*imageRockHeight, imageRock, imageRockWidth, imageRockHeight, null, null));
                            break;
                        case 'N' : environment.add(new Sprite(columnNumber*imageGrassWidth,
                                lineNumber*imageGrassHeight, pathNorth, imageGrassWidth, imageGrassHeight, null, null));
                            break;
                        case 'E' : environment.add(new Sprite(columnNumber*imageGrassWidth,
                                lineNumber*imageGrassHeight, pathEast, imageGrassWidth, imageGrassHeight, null, null));
                            break;
                        case 'S' : environment.add(new Sprite(columnNumber*imageGrassWidth,
                                lineNumber*imageGrassHeight, pathSouth, imageGrassWidth, imageGrassHeight, null, null));
                            break;
